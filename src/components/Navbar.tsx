        ...
        <header className="absolute top-0 pt-5 cLg:top-[55px] cLg:pt-0 z-30 w-full">
            <div className="max-container flex-between px-[15px]">
                ...
                <nav className={`flex-center gap-[60px]`}>
                    <div className={`flex gap-6 cLg:gap-[35px] flex-col cLg:flex-row items-start fixed cLg:static top-0 left-0 w-[300px] cLg:w-auto bg-white cLg:bg-transparent transition-all duration-[400ms] ease-linear cLg:h-auto h-screen p-5  
